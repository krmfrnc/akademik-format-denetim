...
export default function AdminLayout({
  ...
  return (
    <div className="flex min-h-screen">
      <aside
        className={`fixed inset-y-0 left-0 z-40 w-64 transform border-r border-gray-200 bg-gray-900 transition-transform lg:static lg:translate-x-0 ${
      ...
      <div className="flex flex-1 flex-col">
        <header className="flex h-16 items-center border-b border-gray-200 bg-white px-4 lg:px-8">
          <button
